export default function CallToActionSection() {
    return (
        <section className="bg-base-200 pb-24">
            <div className="bg-neutral/80 max-w-7xl mx-auto rounded-2xl flex flex-col place-items-center py-20">
                ...
                <button className="btn btn-primary btn-lg rounded-lg py-8 px-12">
